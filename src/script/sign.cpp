...
bool ProduceSignature(const SigningProvider& provider, const BaseSignatureCreator& creator, const CScript& fromPubKey, SignatureData& sigdata)
{
    ...
    bool fIsP2SH = creator.IsAphoryVersion()
...
public:
    ...
    bool is_aphory_tx = false;
    bool IsAphoryVersion() const override { return is_aphory_tx; }
};
...
SignatureData DataFromTransaction(const CMutableTransaction& tx, unsigned int nIn, const std::vector<uint8_t> &amount, const CScript &scriptPubKey)
{
    ...
    extractor_checker.is_aphory_tx = tx.IsAphoryVersion();
...
class DummySignatureCheckerAphory : public DummySignatureChecker
{
// IsAphoryVersion() must return true to skip stack evaluation
public:
    DummySignatureCheckerAphory() : DummySignatureChecker() {}
    bool IsAphoryVersion() const override { return true; }
};
const DummySignatureCheckerAphory DUMMY_CHECKER_APHORY;

class DummySignatureCreatorAphory : public DummySignatureCreator {
public:
    DummySignatureCreatorAphory() : DummySignatureCreator(33, 32) {}
    const BaseSignatureChecker& Checker() const override { return DUMMY_CHECKER_APHORY; }
    bool IsAphoryVersion() const override { return true; }
};
...
const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_APHORY = DummySignatureCreatorAphory();
