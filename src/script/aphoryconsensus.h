...
#ifndef APHORY_SCRIPT_APHORYCONSENSUS_H
#define APHORY_SCRIPT_APHORYCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBAPHORYCONSENSUS)
...
#endif // APHORY_SCRIPT_APHORYCONSENSUS_H
