...
BOOST_FIXTURE_TEST_SUITE(bech32_tests, AphoryBasicTestingSetup)
...
std::vector<std::pair<std::string, std::string> > testsPass = {
    ...
    std::make_pair("PAPHYKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj", "pep1qqqqqqqqqqqqqqqcpjvcv9trdnv8t2nscuw056mm74cps7jkmrrdq48xpdjy6ylf6vpru36q6zax883gjclngas40d7097mudl05y48ewzvulpnsk5z75kg24d5nf"),
};
