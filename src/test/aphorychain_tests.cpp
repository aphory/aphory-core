...
BOOST_FIXTURE_TEST_SUITE(aphorychain_tests, AphoryBasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(signature_test)
{
    ...
    CMutableTransaction txn;
    txn.nVersion = APHORY_TXN_VERSION;
    txn.nLockTime = 0;
    ...
    txn2.nVersion = APHORY_TXN_VERSION;
...
BOOST_AUTO_TEST_CASE(aphorychain_test)
{
    SeedInsecureRand();
    CBasicKeyStore keystore;
    ...
    CBlock blk;
    blk.nVersion = APHORY_BLOCK_VERSION;
    blk.nTime = 1487406900;
    ...
    txnSpend.nVersion = APHORY_BLOCK_VERSION;
}
...
BOOST_AUTO_TEST_CASE(mixed_input_types)
{
    CMutableTransaction txn;
    txn.nVersion = APHORY_TXN_VERSION;
    BOOST_CHECK(txn.IsAphoryVersion());
    ...
    txnPrev.nVersion = APHORY_TXN_VERSION;
    BOOST_CHECK(txnPrev.IsAphoryVersion());
