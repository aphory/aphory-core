...
BOOST_FIXTURE_TEST_SUITE(extkey_tests, AphoryBasicTestingSetup)
    ...
    */
    ...
    std::vector<DeriveTestData> vMainNetPairs = {
        DeriveTestData(0,
            ...
            std::string("PAPHYKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj")),
        DeriveTestData(1,
            ...
            std::string("PAPHYKPL4rp5WLnrYRpBPySBKNwQbcNxtP22g5PYFeVLri914xwnzewmxBH4dTMd6Xf578bi3sUnLpix65m2gENpWRdwGM5L7fM4Q4FU5StZaV2D")),
        ...
        DeriveTestData(350,
            ...
            std::string("PAPHYNRKDEts7sZSjXXzgDkbHy6waPumHqBAqiTPJsLW4R87st4ibXFs3a9vi3uVdvy14rJQxqfKLKuqnVZboDCadnzgRR1TicCxDYke1jRB4hUk")),
    };
...
void RunSerialiseTests()
{
    ...
    BOOST_CHECK(eKey58.ToString() == "PAPHYKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj");
    ...
    BOOST_CHECK(0 == eKey58.Set58("PAPHYKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj"));
    kp = eKey58.GetKey();
    ...
    BOOST_CHECK(addr.ToString() == "PAPHYKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj");
    dest = addr.Get();
