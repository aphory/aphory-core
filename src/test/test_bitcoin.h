...
struct BasicTestingSetup {
    ...
    explicit BasicTestingSetup(const std::string& chainName = CBaseChainParams::MAIN, bool fAphoryModeIn = false);
    ~BasicTestingSetup();
...
struct TestingSetup : public BasicTestingSetup {
    ...
    explicit TestingSetup(const std::string& chainName = CBaseChainParams::MAIN, bool fAphoryModeIn = false);
    ~TestingSetup();
};
...
struct AphoryBasicTestingSetup : public BasicTestingSetup {
    AphoryBasicTestingSetup() : BasicTestingSetup(CBaseChainParams::MAIN, true) {}
};
