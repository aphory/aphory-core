Contributing to Aphory Core
============================

The Aphory project operates an open contributor model where anyone is
...
The following applies to code changes to the Aphory project..

Whether a pull request is merged into Aphory Core rests with the project merge
...
Patches that change Aphory consensus rules are considerably more involved than
...
[//]: # (Where a patch set proposes to change the Aphory consensus, it must have been
...
The project leader is the release manager for each Aphory Core release.
